...
│                         randomforestsalgorithms and configuration for tools like black
│
...
│
└── randomforestsalgorithms   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes randomforestsalgorithms a Python module
    │
